...
import edu.diego.arzate.torres.Modulo1.evidencia1.priorityQueue;
...
public class process implements Comparable<Process> {
    ...
    public void Process(int minArrivalTime, int maxArrivalTime, int minServiceTime, int maxServiceTime) {
